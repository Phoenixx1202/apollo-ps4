...
const char * menu_about_strings[] = { "Bucanero", "Desenvolvedor",
									"", "",
									"PS3", "credits",
									"Berion", "GUI design",
...
const char * menu_about_strings_project[] = { "ID do usuário", user_id_str,
											"ID da conta", account_id_str,
											"PSID do console", psid_str,
											NULL };
...
static void _draw_AboutMenu(u8 alpha)
{
	...
	DrawStringMono(0, 220, "Versao para playstation 4");
	...
	SetFontSize(APP_FONT_SIZE_JARS);
	DrawStringMono(0, 890, "Em memória de Leon e Luna");
	SetFontAlign(FONT_ALIGN_LEFT);
}
...
static void _draw_LeonLuna(void)
{
	...
	draw_sinetext(860, "... Em memória de Leon e Luna - que seus dias sejam cheios de alegria eterna ...");
}
